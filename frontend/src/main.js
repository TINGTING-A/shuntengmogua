...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'agent-center/:tab?',
                name: 'AgentCenter',
                meta: { title: '智能体中心', requiresAuth: true },
                component: () => import('./components/agent-center/AgentCenterPage.vue')
            },
            {
            ...
            },
            {
                path: 'personal-bus',
                name: 'PersonalBus',
                meta: { title: '个人总线', requiresAuth: true },
                component: () => import('./components/personal-bus/PersonalBusPage.vue')
            },
            {
                path: 'stress-monitor',
                name: 'StressMonitor',
                meta: { title: '压力监测', requiresAuth: true },
                component: () => import('./components/stress-monitor/StressMonitorPage.vue')
            },
            {
                path: 'agent-center/:tab?',
                name: 'AgentCenter',
            ...
            },
            {
                path: 'sprite',
                name: 'SpriteEnhance',
                meta: { title: '精灵增强', requiresAuth: true },
                component: () => import('./components/sprite/SpriteEnhancePage.vue')
            }
        ]
    },
    {
