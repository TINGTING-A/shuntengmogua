              ...
              <el-form-item prop="title">
                <template #label>
                  <div class="flex flex-col gap-1">
                    ...
                    <span class="text-xs text-gray-500 dark:text-gray-400 font-normal">智能助手的显示名称，在对话列表中展示</span>
                  </div>
                </template>
              ...
              <el-form-item prop="description">
                <template #label>
                  <div class="flex flex-col gap-1">
                    ...
                    <span class="text-xs text-gray-500 dark:text-gray-400 font-normal">简要描述智能助手的用途、特点或背景信息</span>
                  </div>
                </template>
              ...
              <el-form-item prop="groupId">
                <template #label>
                  <div class="flex flex-col gap-1">
                    ...
                    <span class="text-xs text-gray-500 dark:text-gray-400 font-normal">将智能助手归类到不同分组，便于管理和查找</span>
                  </div>
                </template>
              ...
              <el-form-item prop="modelId">
                <template #label>
                  <div class="flex flex-col gap-1">
                    ...
                    <span class="text-xs text-gray-500 dark:text-gray-400 font-normal">为此智能助手指定专用的 AI 模型，留空则使用默认模型</span>
                  </div>
                </template>
