    ...
    <div class="flex-1 overflow-hidden">
        ...
        <div v-if="servers.length > 0" class="grid gap-4" style="grid-template-columns: repeat(auto-fill, minmax(360px, 1fr));">
            <div v-for="server in servers" :key="server.id"
                class="rounded-lg border border-gray-200 dark:border-[#232428] overflow-hidden bg-white dark:bg-[#232428] transition-all hover:border-(--color-primary) unified-card">
                <div class="p-5 pb-4">
        ...
        <div v-else class="rounded-lg border border-gray-200 dark:border-[#232428] bg-white dark:bg-[#232428] p-12 text-center unified-card">
