...
import { HunyuanProvider } from './providers/hunyuan/hunyuan.provider';
import { SparkProvider } from './providers/spark/spark.provider';
...
export class LlmCoreModule implements OnModuleInit {
  constructor(
    ...
    private readonly hunyuanProvider: HunyuanProvider,
    private readonly sparkProvider: SparkProvider,
  ) { }
  ...
  onModuleInit() {
    ...
    this.providerHub.register(this.hunyuanProvider);
    this.providerHub.register(this.sparkProvider);
  }
}
