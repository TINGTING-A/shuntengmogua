...
export class AliyunBailianProvider implements IModelProvider {
  ...
  private models: ModelDefinition[] = [
    ...
    // 经典千问系列（按 API 文档常用命名）
    createMultimodalModel("qwen-max", ConfigFragments.ContextWindow._128K),
    createMultimodalModel("qwen-plus", ConfigFragments.ContextWindow._128K),
    createMultimodalModel("qwen-turbo", ConfigFragments.ContextWindow._128K),
    createMultimodalModel("qwen-long", ConfigFragments.ContextWindow._1M),
    createMultimodalModel("qwen3-235b-a22b", ConfigFragments.ContextWindow._128K),
    createMultimodalModel(
    ...
    createMultimodalModel("qwen-vl-max", ConfigFragments.ContextWindow._128K),
    createMultimodalModel("qwen-vl-plus", ConfigFragments.ContextWindow._128K),
    createMultimodalModel(
      "qwen-audio-turbo",
      ConfigFragments.ContextWindow._128K,
    ),
