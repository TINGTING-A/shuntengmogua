...
export class OpenAIProvider implements IModelProvider {
  ...
  private models: ModelDefinition[] = [
    ...
    createMultimodalModel('gpt-4.1', ConfigFragments.ContextWindow._1M, ConfigFragments.WithoutThinking),
    createMultimodalModel('gpt-4.1-mini', ConfigFragments.ContextWindow._1M, ConfigFragments.WithoutThinking),
    createMultimodalModel('gpt-4.1-nano', ConfigFragments.ContextWindow._1M, ConfigFragments.WithoutThinking),
    createMultimodalModel('gpt-4-turbo', ConfigFragments.ContextWindow._128K, ConfigFragments.WithoutThinking),
    createMultimodalModel('gpt-3.5-turbo', ConfigFragments.ContextWindow._33K, ConfigFragments.WithoutThinking),
    ...
    createEmbeddingModel('text-embedding-3-large', ConfigFragments.ContextWindow._8K, ConfigFragments.VectorDim._2000),
  ];
