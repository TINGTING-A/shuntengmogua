...
export class GoogleProvider implements IModelProvider {
  ...
  private models: ModelDefinition[] = [
    ...
    createMultimodalModel('gemini-3-pro-preview', ConfigFragments.ContextWindow._1M, ConfigFragments.MaxOutput._66K),
    ...
    createMultimodalModel('gemini-2.5-flash-lite', ConfigFragments.ContextWindow._1M, ConfigFragments.MaxOutput._66K, ConfigFragments.WithoutThinking),
