...
import { createTextModel, createEmbeddingModel, ConfigFragments } from '../../utils/model-config.helper';
...
export class ZhipuProvider implements IModelProvider {
  ...
  private models: ModelDefinition[] = [
    ...
    createTextModel('GLM-4.5-Flash', ConfigFragments.ContextWindow._128K, ConfigFragments.MaxOutput._96K),
    createTextModel('GLM-4.5-Air', ConfigFragments.ContextWindow._128K, ConfigFragments.MaxOutput._96K),
    // Embedding 模型
    createEmbeddingModel('embedding-3', ConfigFragments.ContextWindow._8K, ConfigFragments.VectorDim._2000),
  ];
