...
export class MoonshotProvider implements IModelProvider {
  ...
  private models: ModelDefinition[] = [
    ...
    createMultimodalModel('kimi-k2', ConfigFragments.ContextWindow._256K),
    createMultimodalModel('kimi-latest', ConfigFragments.ContextWindow._256K),
    createMultimodalModel('kimi-k2-thinking', ConfigFragments.ContextWindow._256K),
    createMultimodalModel('moonshot-v1-8k', ConfigFragments.ContextWindow._8K),
    createMultimodalModel('moonshot-v1-32k', ConfigFragments.ContextWindow._32K),
    createMultimodalModel('moonshot-v1-128k', ConfigFragments.ContextWindow._128K),
  ];
