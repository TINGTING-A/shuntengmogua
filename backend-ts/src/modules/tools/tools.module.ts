...
import { WebToolProvider } from "./providers/web-tool.provider";
import { PptToolProvider } from "./providers/ppt-tool.provider";
import { HtmlSlidesToolProvider } from "./providers/html-slides-tool.provider";
...
@Module({
  ...
  exports: [ToolOrchestrator, ToolContextFactory, WebToolProvider],
})
export class ToolsModule implements OnModuleInit {
  constructor(
    ...
    private readonly webProvider: WebToolProvider,
    private readonly pptProvider: PptToolProvider,
  ...
  onModuleInit() {
    ...
    this.toolOrchestrator.addProvider(this.webProvider);
    this.toolOrchestrator.addProvider(this.pptProvider);
