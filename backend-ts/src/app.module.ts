...
import { PersonalBusModule } from './modules/personal-bus/personal-bus.module';
import { TranslateModule } from './modules/translate/translate.module';
import { BrowserProxyModule } from './modules/browser-proxy/browser-proxy.module';
...
@Module({
  imports: [
    ...
    AgentsModule,     // 12子智能体体系模块
    PersonalBusModule, // 个人总线：CRDT + E2EE + BGE-M3
    TranslateModule, // 翻译：中英互译（LLM）
    BrowserProxyModule, // 网页预览代理：剥离 X-Frame-Options 允许 iframe 嵌入
  ],
})
